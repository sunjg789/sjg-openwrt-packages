...
| luci-app-passwall | Openwrt-Passwall/openwrt-passwall | 科学上网（依赖 openwrt-passwall-packages 自动解析） |
| luci-app-passwall2 | Openwrt-Passwall/openwrt-passwall2 | PassWall2 科学上网（新一代） |
...
| Actions 额度够吗？ | 一次全量约 3–6 小时（两个任务各占一半）；私有仓库 2000 分钟/月，每周一次仍够用。 |
